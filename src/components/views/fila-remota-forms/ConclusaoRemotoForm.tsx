...
export function ConclusaoRemotoForm() {
  const [nome, setNome, resetNome] = useLocalStorage("remoto-conclusao-nome", "");
  const [pib, setPib, resetPib] = useLocalStorage("remoto-conclusao-pib", "");
  const [pibMicro, setPibMicro, resetPibMicro] = useLocalStorage("remoto-conclusao-pib-micro", "");
  ...
  return (
    <div className="mt-3 space-y-2">
      ...
      <FormActions 
        ...
        onReset={handleReset} 
        copyMessage="Nota de Conclusão - Remoto copiada!" 
      />
    </div>
  );
}
